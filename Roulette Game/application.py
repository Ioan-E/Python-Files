...
def compare_numbers(player_nr, cpu_nr, type):
    ...
    if type == 1:
        ...
        return (
            True
            if (cpu_nr[0] % 2 == 0 and player_nr == "EVEN")
            or (cpu_nr[0] % 2 != 0 and player_nr == "ODD")
            else False
        )
    elif type == 4:
        return (
            True
            if (1 <= cpu_nr[0] < 19 and player_nr == "LOW")
            or (19 <= cpu_nr[0] < 37 and player_nr == "HIGH")
            else False
        )
...
def no_more_credit(credit):
    exit = False
    if credit == 0:
        print("You lost your credits. Have a good day")
        exit = True
    return exit
    ...
    while play_game:
        for index, player in enumerate(players):
            ...
            while True:
                ...
                player_choice = (
                    input(betting_params(player_option, "question"))
                ).upper()
