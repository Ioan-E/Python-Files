...
user_DP = Physical('Desired Physical', {'sleep': 56, 'nutrition': 10500, 'physical_exercise': 7}, 23.0)
user_DSp = Spiritual('Desired Spiritual', {'charity': 1, 'meditation': 7, 'contemplation': 1}, 'buddhist')
user_DE = Emotional('Desired Emotional', {'identifying_emotions_in_self': 1, 'identifying_emotions_in_others': 3, 'managing_self_emotions': 3, 'managing_relationships': 7}, 120)
user_DSo = Social('Desired Social', {'monthly_message': 4, 'monthly_meeting': 1, 'randomly_calls': 2}, user_dict_of_friends)
user_DI = Intellectual('Desired Intellectual', {'daily_reading': 50, 'memory_exercises': 10, 'foreign_language': 105, 'online_classes': 1}, 'computer science')

user_AP = Physical('Actual Physical', {'sleep': 50, 'nutrition':10000, 'physical_exercise': 6}, 24.0)
user_ASp = Spiritual('Actual Spiritual', {'charity': 1, 'meditation': 7, 'contemplation': 1}, 'buddhist')
user_AE = Emotional('Actual Emotional',{'identifying_emotions_in_others': 3, 'managing_self_emotions': 3, 'managing_relationships': 7} , 120)
user_ASo = Social('Actual Social',{'monthly_message': 6, 'monthly_meeting': 3, 'randomly_calls': 2} , user_dict_of_friends)
user_AI = Intellectual('Actual Intellectual', {'daily_reading': 15, 'memory_exercises': 10, 'foreign_language': 105, 'online_classes': 1, 'group study': 1}, 'computer science')
...
user_DCollection = DomainsCollection('user\'s Desired Collection', (user_DP, user_DSp, user_DE, user_DSo, user_DI))
user_ACollection = DomainsCollection('user\'s Actual Collection', (user_AP, user_ASp, user_AE, user_ASo, user_AI))
